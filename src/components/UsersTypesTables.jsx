...
import { BASE_URL, USERSTYPES, USERS } from '../api/Api';
...
function UsersTypesTables({ type, Title, link }) {
    ...
    return (
        <div dir={locale === "en" ? "ltr" : "rtl"} className={[locale === "en" ? "ltr" : "rtl", "userstable"].join(" ")}>
          ...
          <a className="stack-export-link" href={link} target="_blank" rel="noopener noreferrer">
...
export default UsersTypesTables