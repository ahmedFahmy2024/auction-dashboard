  ...
  useEffect(() => {
    ...
    Axios.get(`${USERS_COUNT}`,)
      .then(function (response) {
        ...
        setCount(response.data.user_counts.corporate_contractor);
        setLoading(false);
      })
  ...
  return (
    <div dir={locale === "en" ? "ltr" : "rtl"} className={[locale === "en" ? "ltr" : "rtl", "users"].join(" ")}>
      <Container maxWidth="xl">
        ...
        icon3="iwwa:month" 
        />
        <UsersTypesTables type="corporate_contractor" Title="Corporate Contractors" link="https://construction.site-pocket.com/api/export-filtered-users?type=corporate_contractor" />
      </Container>
    </div>
  )
}
