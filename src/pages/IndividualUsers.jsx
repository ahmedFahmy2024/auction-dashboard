...
function IndividualUsers() {
  ...
  useEffect(() => {
    ...
    Axios.get(`${USERS_COUNT}`,)
      .then(function (response) {
        ...
        setCount(response.data.user_counts.individual_contractor);
        setLoading(false);
      })
  ...
  return (
    ...
    icon3="iwwa:month" 
    />
      <UsersTypesTables type="individual_contractor" Title="Individuals Contractors" link="https://construction.site-pocket.com/api/export-filtered-users?type=individual_contractor" />
    </Container>
  </div>
  )
}
