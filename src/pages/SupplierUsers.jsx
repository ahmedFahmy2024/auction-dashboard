...
function SupplierUsers() {
    ...
    useEffect(() => {
      ...
      Axios.get(`${USERS_COUNT}`,)
        .then(function (response) {
          ...
          setCount(response.data.user_counts.supplier);
          setLoading(false);
        })
  ...
  return (
    ...
    icon3="iwwa:month" 
    />
      <UsersTypesTables type="supplier" Title="Suppliers" link="https://construction.site-pocket.com/api/export-filtered-users?type=supplier" />
    </Container>
  </div>
  )
}
